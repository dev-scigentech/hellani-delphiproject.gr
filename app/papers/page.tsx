  ...
  const experts = [
    {
      ...
      affiliation: "Aristotle University of Thessaloniki, AHEPA University Hospital",
      affiliationEl: "Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης, Πανεπιστημιακό Νοσοκομείο ΑΧΕΠΑ",
      researchInterests:
    ...
    },
    {
      ...
      titleEl: "Διευθυντής Νευρολογικής Κλινικής, 251 Γενικό Νοσοκομείο Αεροπορίας",
...

    {
      ...
      researchInterests: "Neuropsychology, Neuroimaging, Neuroimmunology, Multiple Sclerosis Clinical Trials",
      researchInterestsEl: "Νευροψυχολογία, Νευροαπεικόνιση, Νευροανοσολογία, Κλινικές Δοκιμές Πολλαπλής Σκλήρυνσης",
      bioEn:
...

    {
      ...
      affiliation: "Second Department of Neurology, Aristotle University of Thessaloniki",
      affiliationEl: "Β' Νευρολογική Πανεπιστημιακή Κλινική, Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης",
      researchInterests:
    ...
    },
    {
      ...
      phone: "6977123789",
      researchInterests: "Adaptive immunity in autoimmune neurological disorders",
      researchInterestsEl: "Προσαρμοστική ανοσία σε αυτοάνοσες νευρολογικές διαταραχές",
      keywords:
      ...
      links: [
        ...
        { url: "https://www.ncbi.nlm.nih.gov/myncbi/1fUb7QV5ZMHQB/bibliography/public/", label: "PubMed" },
        { url: "https://scholar.google.com/citations?user=OywWjhkAAAAJ&hl=el", label: "Google Scholar" },
        { url: "https://www.linkedin.com/in/panos-stathopoulos-94ba2843/", label: "LinkedIn" },
      ],
    },
  ]
        ...
        <div className="max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <div className="bg-blue-50 rounded-2xl p-8 mb-8 text-left">
              <h2 className="text-2xl font-semibold text-blue-800 mb-4">
                {language === "el" ? paperData.subtitle.el : paperData.subtitle.en}
              </h2>
              {/* Updated description rendering */}
              {(language === "el" ? paperData.description.el : paperData.description.en)
                .split("\n\n")
                .map((paragraph, index) => (
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-blue-600">
                  {language === "el" ? paperData.expertPanel.el : paperData.expertPanel.en}
                </h3>
              </div>

              <div className="space-y-6">
                {experts.map((expert) => (
                  <div key={expert.id} className="bg-gray-50 rounded-xl border border-gray-200 overflow-hidden">
                    {/* Expert Header */}
                    <div className="p-6">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start gap-6 flex-1">
                          ...
                          <div className="flex-shrink-0">
                            <div className="w-24 h-24 rounded-xl overflow-hidden bg-gray-100 border-2 border-gray-200">
                              <img
                                ...
                                alt={`${language === "el" ? expert.nameEl || expert.name : expert.name} headshot`}
                          ...
                          <div className="flex-1">
                            <h4 className="text-xl font-bold text-gray-900 mb-2">
                              {language === "el" ? expert.nameEl || expert.name : expert.name}
                            </h4>
                            <p className="text-blue-600 font-medium mb-3">
                              {language === "el" ? expert.titleEl || expert.title : expert.title}
                            </p>
                            <p className="text-gray-600 mb-4">
                              {language === "el" ? expert.affiliationEl || expert.affiliation : expert.affiliation}
                            </p>
                            ...
                            <div className="flex flex-wrap gap-3">
                              ...
                              {expert.hIndex && (
                                <div className="flex items-center space-x-2 bg-purple-50 px-3 py-1 rounded-full">
                                  ...
                                  <span className="text-sm font-medium text-purple-800">H-Index: {expert.hIndex}</span>
                                </div>
                              )}
                              {expert.experience && (
                                <div className="flex items-center space-x-2 bg-orange-50 px-3 py-1 rounded-full">
                                  <Award className="w-4 h-4 text-orange-600" />
                                  <span className="text-sm font-medium text-orange-800">{expert.experience}</span>
                                </div>
                              )}
                            </div>
                          </div>
                    ...
                    {expandedExperts.has(expert.id) && (
                      <div className="px-6 pb-6 bg-white border-t border-gray-200">
                        <div className="grid md:grid-cols-2 gap-8 pt-6">
                          {/* Biography */}
                          <div>
                            <h5 className="text-lg font-semibold text-gray-900 mb-4">Biography</h5>
                            <div className="prose prose-gray max-w-none">
                              <p className="text-gray-700 leading-relaxed text-sm">
                                {language === "el" ? expert.bioEl || expert.bioEn : expert.bioEn}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="space-y-6">
                            ...
                            {expert.researchInterests && (
                              <div>
                                <h5 className="font-semibold text-gray-900 mb-2">Research Interests</h5>
                                <p className="text-gray-700 text-sm">
                                  {language === "el"
                                    ? expert.researchInterestsEl || expert.researchInterests
                                    : expert.researchInterests}
                                </p>
                              </div>
                            )}
                            ...
                            {expert.keywords && (
                              <div>
                                <h5 className="font-semibold text-gray-900 mb-2">Key Research Areas</h5>
                                <div className="flex flex-wrap gap-2">
                                  {(language === "el" ? expert.keywordsEl || expert.keywords : expert.keywords)
                                    .split(", ")
                                    .map((keyword, index) => (
                                      <span
                                        key={index}
                            ...
                            {expert.clinicalTrials && (
                              <div>
                                <h5 className="font-semibold text-gray-900 mb-2">Clinical Trials</h5>
                                <p className="text-gray-700 text-sm">{expert.clinicalTrials}</p>
                              </div>
                            )}
                            ...
                            {expert.awards && (
                              <div>
                                <h5 className="font-semibold text-gray-900 mb-2">Awards</h5>
                                <p className="text-gray-700 text-sm">{expert.awards}</p>
                              </div>
                            )}
                            ...
                            {expert.clinicalRole && (
                              <div>
                                <h5 className="font-semibold text-gray-900 mb-2">Clinical Role</h5>
                                <p className="text-gray-700 text-sm">{expert.clinicalRole}</p>
                              </div>
                            )}
                            ...
                            {expert.links && expert.links.length > 0 && (
                              <div>
                                <h5 className="font-semibold text-gray-900 mb-2">External Links</h5>
          ...
          <section className="mb-12">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-blue-600">
                  {language === "el" ? paperData.meetingParticipants.el : paperData.meetingParticipants.en}
                </h3>
              </div>
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                <div className="space-y-2">
                  {(language === "el" ? meetingData.participants.el : meetingData.participants.en).map(
                    (participant, index) => (
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-green-600">
                  {language === "el" ? paperData.questionnaire.el : paperData.questionnaire.en}
                </h3>
              </div>
              <p className="text-gray-700 mb-6">
                {language === "el" ? paperData.questionnaireDescription.el : paperData.questionnaireDescription.en}
              </p>
          ...
          <section className="mb-12">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-blue-600">
                  {language === "el" ? paperData.bibliography.el : paperData.bibliography.en}
                </h3>
              </div>
          ...
          <section className="mb-12">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-blue-600">
                  {language === "el" ? paperData.finalConsensusMeeting.el : paperData.finalConsensusMeeting.en}
                </h3>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-orange-50 rounded-xl p-6 border border-orange-200">
                  <h4 className="font-semibold text-orange-800 mb-3 flex items-center">
                    ...
                    {language === "el" ? paperData.meetingDate.el : paperData.meetingDate.en}
                  </h4>
                  <p className="text-gray-700 font-medium">
                    {language === "el" ? meetingData.date.el : meetingData.date.en}
                  </p>
                </div>

                <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                  <h4 className="font-semibold text-blue-800 mb-3">
                    {language === "el" ? paperData.meetingLocation.el : paperData.meetingLocation.en}
                  </h4>
                  <p className="text-gray-700">
                    {language === "el" ? meetingData.location.el : meetingData.location.en}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              ...
              {language === "el" ? paperData.backToHome.el : paperData.backToHome.en}
            </Link>
            <Link
              href="/"
              className="inline-flex items-center px-6 py-3 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 transition-colors duration-300 font-medium"
            >
              {language === "el" ? paperData.otherThemes.el : paperData.otherThemes.en}
            </Link>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                {language === "el" ? paperData.entryTitle.el : paperData.entryTitle.en}
              </h3>
              <p className="text-gray-600">
                {language === "el" ? paperData.entryDescription.el : paperData.entryDescription.en}
              </p>
            </div>
